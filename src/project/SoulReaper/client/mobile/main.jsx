...
class App extends React.Component {
    ...
    render() {
        return <div>
            ...
            <div className="histoire" style={this.state.anchor == "histoire" ? {} : {display: "none"}}>

            </div>
            <div className="personnages" style={this.state.anchor == "personnages" ? {} : {display: "none"}}>

            </div>
            <div className="galerie" style={this.state.anchor == "galerie" ? {} : {display: "none"}}>

            </div>
            <div className="infos" style={this.state.anchor == "infos" ? {} : {display: "none"}}>
            ...
            <div className="bottom">
                ...
                {
                    ["home", "histoire", "personnages", "galerie", "infos"].map(d=> {
