    ...
    init: function init(table) {
        ...
        switch (table) {
            ...
            case "cpDisplay":
                ...
                break;
            case "follow":
                d = [{ id: "id", name: "id", checked: false }, { id: "name", name: "游戏名称", checked: true }, { id: "followStatus", name: "跟进标签", checked: true, select: true }, { id: "lastContact", name: "最后联系时间", checked: true }, { id: "admin", name: "负责人", checked: true, select: true }, { id: "createTime", name: "录入时间", checked: false }, { id: "updateTime", name: "更新时间", checked: false }];
                break;
            case "game":
                d = [{ id: "id", name: "id", checked: false }, { id: "name", name: "游戏名称", checked: true }, { id: "publisher", name: "发行商", checked: true }, { id: "developer", name: "研发商", checked: true }, { id: "type", name: "游戏类型", checked: true }, { id: "play", name: "玩法", checked: true }, { id: "ip", name: "IP", checked: true }, { id: "theme", name: "题材", checked: true }, { id: "online", name: "上线情况", checked: true }, { id: "performance", name: "上线表现", checked: true }, { id: "lastContact", name: "最后联系时间", checked: true }, {
                    id: "contactWay", name: "沟通方式", checked: true, type: "radio", radioArr: ["初步网上/电话沟通", "网上/电话长期跟进资料", "网上/电话深度沟通（合作意向尚不明确）", "网上/电话深度沟通（已明确合作意向）", "已约定见面（去对方公司拜访）", "已约定见面（来我公司拜访）", "已见面（去对方公司拜访）", "已见面（来我公司拜访）", "已见面（已互相拜访）"]
                }, { id: "agentCondition", name: "代理条件", checked: true }, { id: "admin", name: "负责人", checked: true }, {
                    id: "followStatus", name: "跟进标签", checked: true, type: "radio", radioArr: ["等待出包", "评测中", "跟进新包，包完成度不够", "等待上线数据", "初步沟通合作意向(评测通过)", "初步沟通合作意向(已上线产品)", "已被其他公司代理", "开发自己发行", "我方主动放弃", "合作协议推进失败", "双方明确合作意向", "签订测试协议", "签订代理协议"]
